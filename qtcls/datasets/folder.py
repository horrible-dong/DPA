...
def find_classes(directory: str) -> Tuple[List[str], Dict[str, int]]:
    ...
    # class_to_idx = {cls_name: i for i, cls_name in enumerate(classes) if i == 0}
...
class ImageFolder(BaseDataset):
    def __init__(self, root, split, transform=None, target_transform=None, loader=None, is_valid_file=None):
